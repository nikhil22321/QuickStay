...
const RoomDetails = () => {
    ...
    const checkAvailability = async (e) => {
        try {
            ...
            const { data } = await axios.post('/api/bookings/check-availability', {room: id, checkInDate, checkOutDate, guests})
            if (data.success) {
                if(data.isAvailable) {
                    setIsAvailable(true);
    ...
    // onSubmit handler for booking to check availability and book the room
